...
const Menu = () => {
    ...
    const contactUseTriggerRef = useRef(null)
    ...
    return (
        <div className="">
            <div className="hidden lg:flex text-white items-center  gap-10 text-sm font-medium">
                ...
                <div  className=" cursor-pointer flex gap-2 items-center justify-between text-sm  text-white " id="conactUsTrigger" >
                    <Link href="">Contact us</Link>
                </div>

            </div>
            <div className={`hidden z-10 lg:block custom-gradient-background-style  w-[100%] top-[72px] left-0 absolute px-36   border-b-[#31D2F2] ease duration-300 ${activeIndex === 1 ? "h-[70vh] p-t-8 border-b-1" : "pt-0 h-0 border-b-0"} overflow-hidden`}>
                <WhatWeDo />
            </div>
            <div className={`hidden z-10 lg:block custom-gradient-background-style  w-[100%] top-[72px] left-0 absolute px-36   border-b-[#31D2F2] ease duration-300 ${activeIndex === 2 ? "h-[70vh] p-t-8 border-b-1" : "pt-0 h-0 border-b-0"} overflow-hidden`}>
                <WhatWeAre />
            </div>
            <div className={`hidden z-10 lg:block custom-gradient-background-style  w-[100%] top-[72px] left-0 absolute px-36   border-b-[#31D2F2] ease duration-300 ${activeIndex === 3 ? "h-[70vh] p-t-8 border-b-1" : "pt-0 h-0 border-b-0"} overflow-hidden`}>
                <Carrers />
            </div>
        </div>
